...
<div class="col-lg-12">
	<div class="d-flex justify-content-between align-items-center w-100 form-group">
		...
		<button class="btn btn-sm btn-primary bg-gradient-primary" type="button" id="manage_playlist"><i class="fa fa-plus"></i> <span class="responsive-font">Add New Playlist</span></button>
	</div>

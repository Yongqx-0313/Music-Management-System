...
<div class="col-lg-12">
	<div class="d-flex justify-content-between align-items-center w-100 form-group">
	...
	<div class="row" id="music-list">
		...
		?>
			<div class="card bg-black music-item my-2 mx-1 custom-width" data-id="<?php echo $row['id'] ?>" data-upath="<?php echo $row['upath'] ?>" style="cursor:pointer;">
				<div class="card-img-top flex-w-100 position-relative py-2 px-3">
					...
					<span class="position-absolute" style="bottom:.5em;left:.5em;z-index: 2">
						<div class="btn bg-green rounded-circle d-flex justify-content-center align-items-center" style="width: 2rem;height: 2rem;cursor: pointer;" onclick="play_music({0:{id:'<?php echo $row['id'] ?>',upath:'assets/uploads/<?php echo $row['upath'] ?>'}})"><i class="fa fa-play"></i></div>
					</span>
